...
from models import JobContext, Candidate, Evaluation, RecommendationType, InterviewPriority
...
class TestAIClient:
    ...
    def test_gpt5_parameter_handling(self):
        ...
        mock_response.choices[0].message.content = '{"overall_score": 75, "recommendation": "YES", "strengths": ["test"], "concerns": ["test"], "interview_priority": "MEDIUM", "detailed_notes": "test"}'
